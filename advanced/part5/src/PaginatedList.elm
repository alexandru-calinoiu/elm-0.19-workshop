...
view : PaginatedList a -> (Int -> msg) -> Html msg
view list toMsg =
    let
        viewPageLink currentPage =
            pageLink currentPage (currentPage == page list) toMsg
    in
...
pageLink : Int -> Bool -> (Int -> msg) -> Html msg
pageLink targetPage isActive toMsg =
